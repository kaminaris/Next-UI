...
@NgModule({
	declarations: [
		...
		// Config Windows
		ConfigWindowMainComponent, ConfigWindowPlayerComponent, ConfigWindowTargetComponent, ConfigPartyComponent,
		ConfigAuraComponent,
		ConfigTargetOfTargetComponent, ConfigTTSComponent, ConfigAggroListComponent, ConfigWindowColorComponent,
		ConfigWindowProfileComponent, ConfigWindowAuraFilterComponent,
